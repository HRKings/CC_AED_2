...
class ListaTime {
	...
	public boolean pesquisar(String nome) {
		...
		for (int i = 0; i < n && retorno == false; i++) {
			comparacoes++;
		   retorno = (array[i].getNome().equals(nome));
		}
		return retorno;
	     }
...
class PesquisaSequencial {
	...
	public static void main(String[] args) {
		...
		} while (!pesquisa[numPesquisa++].equals("FIM"));
		...
		Arq.openWriteClose("66978_sequencial.txt", "UTF-8", "66978\t" + (fim-comeco)/1000.0 + "\t" + lista.comparacoes);
